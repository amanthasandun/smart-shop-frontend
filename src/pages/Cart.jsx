...
const Cart = () => {
    const {user , axios , products , currency , cartItems , removeFromCart , getCartCount , updateCartItem , navigate , getCartAmount }=useAppContext()
    
    const [cartArray , setCartArray] = useState([])
    const [addresses , setAddresses] = useState([])
    const [showAddress, setShowAddress] = useState(false)
    const [selectedAddress, setSelectedAddress] = useState(null)
    const [paymentOption, setPaymnetOption] = useState("COD")
        ...
        <div className="flex flex-col md:flex-row mt-6">
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <select 
                                        onClick={(e)=>e.stopPropagation()} onChange={e => updateCartItem(product._id , Number(e.target.value))} 
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <select onClick={e => setPaymnetOption(e.target.value)} className="w-full border border-gray-300 bg-white px-3 py-2 mt-2 outline-none">
