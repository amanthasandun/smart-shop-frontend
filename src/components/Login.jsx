...
const Login = () => {
    ...
    const onSubmitHandler = async (event) => {
        event.preventDefault();  // prevent the deafult action of the form

        setUser({ // I think this is an tempory data , if user enter any thing to form but the website work with this data
